...
def stack_batch(inputs: List[torch.Tensor],
    ...
    for i in range(len(inputs)):
        ...
        if data_samples is not None:
            ...
            if 'gt_rgb_map' in data_sample:
                gt_rgb_map = data_sample.gt_rgb_map.data
                del data_sample.gt_rgb_map.data
                data_sample.gt_rgb_map.data = F.pad(
                    gt_rgb_map, padding_size, value=seg_pad_val)
                pad_shape = data_sample.gt_rgb_map.shape                
